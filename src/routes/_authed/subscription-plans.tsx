...
import { adminSubscriptionPlansQueryOptions } from "@/lib/queries/admin";
import {
...
export const Route = createFileRoute("/_authed/subscription-plans")({
  beforeLoad: ({ context }) =>
...
function SubscriptionPlansPage() {
  ...
  function invalidate() {
    // The member app caches the public plan list separately; it re-fetches on its
    // own staleTime, so there is nothing to invalidate across the origin boundary.
